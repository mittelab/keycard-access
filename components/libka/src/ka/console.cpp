...
namespace ka {
    struct console::console_setup {
        console_setup(console_setup const &) = delete;
        console_setup(console_setup &&) = delete;
        console_setup &operator=(console_setup const &) = delete;
        console_setup &operator=(console_setup &&) = delete;
        ...
        [[nodiscard]] static std::shared_ptr<console_setup> get_or_make_instance() {
            static std::mutex _mtx;
            std::unique_lock<std::mutex> lock{_mtx};

            static std::weak_ptr<console_setup> _weak_ptr{};

            if (auto strong_ptr = _weak_ptr.lock(); strong_ptr) {
                return strong_ptr;
            } else {
                strong_ptr = std::make_shared<console_setup>();
                _weak_ptr = strong_ptr;
                return strong_ptr;
            }
        }
    };
    ...
    console::console() : _raii{console_setup::get_or_make_instance()} {}
