...
namespace ut {
    ...
    struct test_bundle {
        ...
        ka::gate g0{ka::key_pair{{0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f,
                    ...
                    0_g, ka::pub_key{km_kp.raw_pk()}, g0_bk};
        ...
        ka::gate g13{ka::key_pair{{0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x58, 0x59, 0x5a, 0x5b, 0x5c, 0x5d, 0x5e, 0x5f,
                     ...
                     13_g,
                     ka::pub_key{km_kp.raw_pk()},
                     g13_bk};

        ka::gate_config g0_cfg{ka::gate_credentials{ka::pub_key{g0.keys().raw_pk()}, g0_bk}, 0_g};

        ka::gate_config g13_cfg{ka::gate_credentials{ka::pub_key{g13.keys().raw_pk()}, g13_bk}, 13_g};
